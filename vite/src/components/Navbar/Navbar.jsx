    ...
    return (
        <nav className="navbar bg-warning  align-content-center" >
            ...
            <div className="w-50 d-flex justify-content-end align-items-center position-absolute top-0 end-0 navend">
                <nav className={` d-flex align-items-center navbar_cont ${showLinks ? 'show_nav' : "hide_nav"}`}>
                ...
                <div>
                    <a href="billeterie.html">
                        <img className="billet" src={billet} alt="billeterie" />
                    </a>

                    <img className='navbar_burger burger bg-orange ico64' onClick={handleShowLinks} src={burger} alt="burger menu icon" />
